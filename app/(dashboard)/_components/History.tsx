        ...
        <Card className='col-span-12 mt-2 w-full'>
            ...
            <CardContent>
                <SkeletonWrapper isLoading={historyDataQuery.isFetching}>
                    ...
                    {!dataAvailable && 
                    <Card className='flex h-[300px] flex-col justify-center items-center'>
                        No data available for the selected period  
                        <p className='text-sm text-muted-foreground'>Try selecting a diffrent period or add new transactions</p>  
                    </Card>}
